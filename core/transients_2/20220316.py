...
# 定义权重
weight_data = {'RyR4': 50, 'RyR6': 100, 'RyR8': 50}
...
plt.plot(x, y)
plt.plot(csv_data_ryr4.index.values, csv_data_ryr4[0].values)
plt.plot(csv_data_ryr6.index.values, csv_data_ryr6[0].values)
plt.plot(csv_data_ryr8.index.values, csv_data_ryr8[0].values)

# plt.plot(x_smooth, y_smooth)

plt.legend(labels=["叠加", "4通道", "6通道", "8通道"], fontsize=13)
plt.title("gn")
plt.xlim((0, 500))
plt.xticks([0, 100, 200, 300, 400, 500], [0, 20, 40, 60, 80, 100], fontsize=13)
plt.xlabel("time(ms)", fontsize=14)
