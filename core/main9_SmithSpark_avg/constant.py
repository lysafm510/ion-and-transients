...
SAVE_PATH = "test11_20220705_random4_avg"
# 请把钙空穴网格以及网格三角形单元数据在grid、triangle_number包下，并输入路径
TRIANGLE_PATH = "25RyR_radius_0.8_random4_0501"
GRID_PATH = "25RyR_radius_0.8_random4_0501"
...
# 钙离子结合荧光染料
DCAF = 2 * 10 ** 7  # jSR扩散系数
K1 = 48800  # KF+  Ca离子和fluo-5N的结合速率
K2 = 19520  # KF-  Ca离子和fluo-5N的解离速率
# 钙离子结合缓冲物
