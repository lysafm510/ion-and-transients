...
from constant import SAVE_PATH, CCAJSR, CCAF, START_STEP, RELEASE_TIME, DT, END_TIME, SAVE_INTERVAL, DCARYR, CCAMYO, R, \
    T, Z, Far
...
def do_loop_diffusion():
    ...
    while times <= END_TIME:
        ...
        if times >= (RELEASE_TIME - DT / 2):
            ...
            vm, nernst, d_ca_ryr = get_d_ca_ryr(vm, i_ca_ryr, i_ca_fsr, avg_ca_jsr, CCAMYO)
